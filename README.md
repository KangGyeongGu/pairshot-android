...
| 버전 | 날짜 | 주요 내용                                                                                       |
|------|------|---------------------------------------------------------------------------------------------|
| [v1.6.0](./docs/releases/v1.6.0.md) | 2026-09-21 | 기기 갤러리에서 비포 및 애프터 사진 추가 기능                                                                  |
| [v1.5.2](./docs/releases/v1.5.2.md) | 2026-07-23 | Android 16(API 36) 타겟팅 상향                                                                   |
| [v1.5.1](./docs/releases/v1.5.1.md) | 2026-06-29 | 전후 사진 합성 종횡비 1:1 통일 · AFTER 스트립 카드 촬영 방향 아이콘 추가                                             |
| [v1.5.0](./docs/releases/v1.5.0.md) | 2026-06-17 | 최초 설치 페이월 닫기 버튼 추가 · 광고 제거 전용 프로모션 폐기 및 프로모션 혜택 Pro 통일                                      |
| [v1.4.1](./docs/releases/v1.4.1.md) | 2026-06-08 | 약관·개인정보·홈페이지 외부 링크 도메인 전환 · 프로모션 등록 다이얼로그 마사용 안내 라벨 제거                                      |
| [v1.4.0](./docs/releases/v1.4.0.md) | 2026-05-30 | 무료버전 내보내기 프리셋 개수 제한 추가 · 화면 별 재사용 컴포넌트 (카드그리드, 삭제 패널) 재사용 로직 리팩터링                           |
| [v1.3.2](./docs/releases/v1.3.2.md) | 2026-05-24 | 결제 화면 구독 카드 정리 — 연간 할인율 가격 기반 자동 계산 · 하단 보조 링크 순서 교체                                        |
| [v1.3.1](./docs/releases/v1.3.1.md) | 2026-05-24 | 앱 텍스트 크기 설정 추가 · 튜토리얼 폰트 사이즈 오류 해결 · BEFORE 크게보기 닫기 안내 단계 추가                                |
| [v1.3.0](./docs/releases/v1.3.0.md) | 2026-05-23 | 합성 레이블 "테두리 내부" 옵션 추가 · AFTER 촬영 스트립 BEFORE 롱프레스 미리보기 기능 추가 · PRO 구독 옵션 진입점 + paywall 자동 닫힘 방지 |
| [v1.2.2](./docs/releases/v1.2.2.md) | 2026-05-17 | 튜토리얼 UX 개선                                                                                  |
| [v1.2.1](./docs/releases/v1.2.1.md) | 2026-05-17 | Play Console 프로덕션 릴리즈용 버전 빌드                                                                |
| [v1.2.0](./docs/releases/v1.2.0.md) | 2026-05-17 | 튜토리얼 기능 추가 · Google Play 구독·프로모션 통합 ·  카메라 비율·내보내기 파이프라인 보강                                 |
